"""Awful first attempt.  Works on test cases, fails on actual data.  Took over 2 hours for this mess!"""
...
bits = "".join([str(bin(int(bit, 16))[2:].zfill(4)) for bit in bits[0].strip()])
