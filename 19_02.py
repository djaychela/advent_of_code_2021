...
class Scanner:
    id_: str
    points: list = field(default=list, init=False)
    distances: list = field(default_factory=list, init=False)
    offset: list = field(default_factory=list, init=False)
    axis_sign: list = field(default_factory=list, init=False)
    axis_map: list = field(default_factory=list, init=False)
